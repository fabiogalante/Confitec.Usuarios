...
{
    public class AlterarUsuariosRequest : BaseRequest
    {
        ...
        public override void Validate()
        {
            ...
            if (!System.Enum.TryParse(Escolaridade, out _escolaridade))
                AddNotification(Escolaridade,
                    "Escolaridade inválida. PERMITIDOS [Infantil, Fundamental, Medio, Superior]");

        }


        public static implicit operator Usuario(AlterarUsuariosRequest request)
        {
            return new Usuario
            {
                Id = request.Id,
